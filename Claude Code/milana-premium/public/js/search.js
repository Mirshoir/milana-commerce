...
(() => {
  ...
  const PAGES = [
    ...
    { href: "/privacy", key: "privacy.title", kw: "конфиденциальность персональные данные privacy personal data maxfiylik" },
    { href: "/delete-account", key: "delete.title", kw: "удалить аккаунт delete account deletion удалить данные akkauntni o'chirish" },
