(() => {
  ...
  const TEXT = {
    en: {
      ...
      "Категории одежды": "Clothing categories",
      "Справочники": "Dictionaries",
      "Категории гендера": "Gender categories",
      "Панели каталога": "Catalog panels",
      "Типы товара": "Product types",
      "Теги": "Tags",
      "Размерный ряд": "Size range",
      "Страны производства": "Countries of manufacture",
      "Цвета": "Colors",
      "Полотно (материал)": "Fabric (material)",
      "Состав ткани": "Fabric composition",
      "Сезон": "Season",
      "Коллекции": "Collections",
      "Панель каталога": "Catalog panel",
      ...
      "Введите название новой категории одежды. Оно сразу появится в этом списке и в справочниках.": "Enter the new clothing category name. It will appear in this list and in Dictionaries immediately.",
      "Переключатель в списке товаров меняет «В наличии» на «Предзаказ», не скрывая товар. Чтобы полностью скрыть товар, выключите «Показывать на сайте».": "The product-list switch changes In stock to Preorder without hiding the product. To hide it completely, turn off Show on site.",
      "Тег": "Tag",
      "Цена": "Price",
      "Статус": "Status",
      ...
      "В наличии": "In stock",
      "Предзаказ": "Preorder",
      "Товар переведён в предзаказ": "Product moved to preorder",
      "Товар в наличии": "Product is in stock",
      "Категория добавлена": "Category added",
      "Эта категория уже есть": "This category already exists",
      "Новый": "New",
      "В работе": "Processing",
      "Отправлен": "Shipped",
      "Выполнен": "Done",
    ...
    uz: {
      ...
      "Категории одежды": "Kiyim kategoriyalari",
      "Справочники": "Ma'lumotnomalar",
      "Категории гендера": "Jins kategoriyalari",
      "Панели каталога": "Katalog panellari",
      "Типы товара": "Mahsulot turlari",
      "Теги": "Teglar",
      "Размерный ряд": "O'lcham qatori",
      "Страны производства": "Ishlab chiqaruvchi davlatlar",
      "Цвета": "Ranglar",
      "Полотно (материал)": "Mato (material)",
      "Состав ткани": "Mato tarkibi",
      "Сезон": "Mavsum",
      "Коллекции": "Kolleksiyalar",
      "Панель каталога": "Katalog paneli",
      "Тип товара": "Mahsulot turi",
      "Страна производства": "Ishlab chiqaruvchi davlat",
      "Коллекция": "Kolleksiya",
      "Цвет": "Rang",
      "+ Добавить": "+ Qo'shish",
      "Добавить категорию": "Kategoriya qo'shish",
      "Введите название новой категории одежды. Оно сразу появится в этом списке и в справочниках.": "Yangi kiyim kategoriyasi nomini kiriting. U darhol ushbu ro'yxat va ma'lumotnomalarda paydo bo'ladi.",
      "Переключатель в списке товаров меняет «В наличии» на «Предзаказ», не скрывая товар. Чтобы полностью скрыть товар, выключите «Показывать на сайте».": "Mahsulotlar ro'yxatidagi tugma mahsulotni yashirmasdan Mavjud holatidan Oldindan buyurtmaga o'tkazadi. To'liq yashirish uchun Saytda ko'rsatishni o'chiring.",
      "Тег": "Teg",
      "Цена": "Narx",
      "Статус": "Holat",
      ...
      "Комплект одежды": "Kiyim to'plami",
      ...
      "Товар переведён в предзаказ": "Mahsulot oldindan buyurtmaga o'tkazildi",
      "Товар в наличии": "Mahsulot mavjud",
      "Категория добавлена": "Kategoriya qo'shildi",
      "Эта категория уже есть": "Bu kategoriya allaqachon mavjud",
      "Новый": "Yangi",
      "В работе": "Jarayonda",
  ...
  const PLACEHOLDER = {
    en: {
      ...
      "Например: Платья": "For example: Dresses",
      "—": "-",
      "XS, S, M, L": "XS, S, M, L",
    ...
    uz: {
      ...
      "Например: Платья": "Masalan: Ko'ylaklar",
      "—": "-",
      "XS, S, M, L": "XS, S, M, L",
      "998901234567": "998901234567"
    }
  ...
  const TITLES = {
    en: {
      ...
      "Скрыт с сайта": "Hidden from site",
      "Перевести в наличие": "Move to in stock",
      "Перевести в предзаказ": "Move to preorder",
      "Изменить": "Edit",
      "Удалить": "Delete",
      "Влево": "Left",
      "Вправо": "Right"
    ...
    uz: {
      ...
      "Скрыт с сайта": "Saytdan yashirilgan",
      "Перевести в наличие": "Mavjud holatiga o'tkazish",
      "Перевести в предзаказ": "Oldindan buyurtmaga o'tkazish",
      "Изменить": "Tahrirlash",
      "Удалить": "O'chirish",
      "Влево": "Chapga",
      "Вправо": "O'ngga"
